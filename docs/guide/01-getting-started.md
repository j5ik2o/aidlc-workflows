...
| Kimi Code | `kimi` | `kimi` | `/skill:aidlc` |
...
| Kimi Code | Sign in with `kimi` and append the shipped hook snippet to the user config | [Kimi Code](harnesses/kimi-code.md) |

## AWS Bedrock Setup

The Claude Code distribution ships configured for Amazon Bedrock. Codex inherits
your existing Codex model and authentication; other harnesses use their own
