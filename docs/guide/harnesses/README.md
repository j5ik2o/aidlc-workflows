...
| **Codex CLI** (≥ 0.145.0) | `$aidlc` | [AI-DLC on Codex CLI](codex-cli.md) — prerequisites, trust pre-seed, model/authentication setup, the git-repo requirement. |
...
| **Kimi Code** | `/skill:aidlc` | [AI-DLC on Kimi Code](kimi-code.md) — install, the one-time user-level hooks snippet, `Agent`-tool dispatch, what's different on Kimi. |
