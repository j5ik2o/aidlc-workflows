...
on the harness you use — Claude Code, Kiro CLI, Kiro IDE, Codex CLI, Cursor, opencode, GitHub Copilot, or Kimi Code: 14 agents
...
`dist/opencode/`, `dist/copilot/`, and `dist/kimi/`) are **generated**
