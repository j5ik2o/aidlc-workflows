...
param(
  [Parameter()]
  [ValidatePattern('^(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)(-j5ik2o\.(0|[1-9][0-9]*))?$')]
  [string]$Version,
...
try {
  ...
  if ($manifest.schemaVersion -ne 1 -or $manifest.version -notmatch '^(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)(-j5ik2o\.(0|[1-9][0-9]*))?$') {
    Stop-Install -Code 4 -Status 'failed' `
