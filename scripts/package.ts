...
function rewriteClaudeNativePermissions(outRoot: string, m: HarnessManifest): void {
  ...
  // A claude-flavored harness that registers hooks outside the project (Kimi
  // reads them only from the user-level config) ships no settings.json, so
  // there is no permission list to rewrite.
