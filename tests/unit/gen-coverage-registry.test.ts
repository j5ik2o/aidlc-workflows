...
describe("mechanismsOf is body-derived (milestone 3)", () => {
  ...
  const EXPECTED_NONE_TO_CLI = [
    ...
    // t338 spawns the shipped kimi hook adapter as a subprocess because the
    // payload-conversion contract under test is the process's stdin/stdout
    // boundary, not an in-process function call.
    "unit/t338-kimi-hook-adapter.test.ts",
    // t339 spawns the real doctor through the process boundary because the
    ...
    "unit/t339-kimi-doctor-hooks.test.ts",
