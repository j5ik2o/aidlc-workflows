...
`bun .kimi-code/tools/aidlc-orchestrate.ts report --stage delivery-planning --result <outcome>`.
...
`bun .kimi-code/tools/aidlc-state.ts set-construction-iteration unit-major`.
...
`bun .kimi-code/tools/aidlc-state.ts set-construction-iteration unit-major`,
then
`bun .kimi-code/tools/aidlc-state.ts set-unit-ownership team`. Team ownership
...
`bun .kimi-code/tools/aidlc-state.ts set-unit-gate-rhythm per-stage` or
