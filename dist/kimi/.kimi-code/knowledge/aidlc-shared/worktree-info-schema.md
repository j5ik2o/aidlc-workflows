...
```
bun .kimi-code/tools/aidlc-worktree.ts info --slug <kebab-slug>
```
...
- Implementation: `.kimi-code/tools/aidlc-worktree.ts` (`handleInfo` handler)
- Test: `tests/unit/t72-worktree-info.sh`
- Caller: `.kimi-code/skills/aidlc/SKILL.md` (per-Bolt-loop halt-and-ask flow)
...
- Audit-format spec: `.kimi-code/knowledge/aidlc-shared/audit-format.md` `WORKTREE_CREATED` row
