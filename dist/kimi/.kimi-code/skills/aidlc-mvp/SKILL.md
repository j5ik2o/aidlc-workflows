...
description: >
  ...
  detection. Skip operations, ship the core. Packaging over `/skill:aidlc --scope mvp`, which works
  without this skill.
...
1. `directive = bun .kimi-code/tools/aidlc-orchestrate.ts next --scope mvp $ARGUMENTS`
