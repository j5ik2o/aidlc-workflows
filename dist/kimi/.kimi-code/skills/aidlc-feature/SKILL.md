...
description: >
  ...
  detection. Full lifecycle for new features, practical depth. Packaging over `/skill:aidlc --scope feature`, which works
  without this skill.
...
1. `directive = bun .kimi-code/tools/aidlc-orchestrate.ts next --scope feature $ARGUMENTS`
