...
description: >
  ...
  detection. CVE response. Packaging over `/skill:aidlc --scope security-patch`, which works
  without this skill.
...
1. `directive = bun .kimi-code/tools/aidlc-orchestrate.ts next --scope security-patch $ARGUMENTS`
